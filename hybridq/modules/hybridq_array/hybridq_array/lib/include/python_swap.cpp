...
int swap(type *array, const unsigned int *pos, const unsigned int n_qubits,
...
static_assert(sizeof(short) * 8 == 16);
static_assert(sizeof(int) * 8 == 32);
static_assert(sizeof(long) * 8 == 64);
...
int swap_float128(long double *array, const unsigned int *pos,
                  const unsigned int n_qubits, const unsigned int n_pos) {
  return hybridq::python::swap(array, pos, n_qubits, n_pos);
}

int swap_int8(char *array, const unsigned int *pos, const unsigned int n_qubits,
              const unsigned int n_pos) {
  return hybridq::python::swap(array, pos, n_qubits, n_pos);
}

int swap_int16(short *array, const unsigned int *pos,
               const unsigned int n_qubits, const unsigned int n_pos) {
  return hybridq::python::swap(array, pos, n_qubits, n_pos);
}
...
int swap_uint8(unsigned char *array, const unsigned int *pos,
               const unsigned int n_qubits, const unsigned int n_pos) {
  return hybridq::python::swap(array, pos, n_qubits, n_pos);
}

int swap_uint16(unsigned short *array, const unsigned int *pos,
                const unsigned int n_qubits, const unsigned int n_pos) {
  return hybridq::python::swap(array, pos, n_qubits, n_pos);
}
